...
def go_repositories():
    ...
    go_repository(
        ...
        sum = "h1:oT7VstCUxWBoX7fswYK61fi9bzRBSpROq5CR2b7wxQo=",
        version = "v0.9.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:2K9ivTD3teEO+2fXV6zrZKDqk5IuU2aJtBDo8U7omWU=",
        version = "v1.8.7",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:3aFKDyPT5wE26maD84lCkyVBsrKMVS4auOlwE41vNc4=",
        version = "v0.36.4",
    )
    go_repository(
