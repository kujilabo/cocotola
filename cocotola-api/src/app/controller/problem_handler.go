...
func (h *problemHandler) FindProblems(c *gin.Context) {
	...
	controllerhelper.HandleSecuredFunction(c, func(organizationID userD.OrganizationID, operatorID userD.AppUserID) error {
		...
		if err != nil {
			return liberrors.Errorf("converter.ToProblemFindResponse. err: %w", err)
		}
...
func (h *problemHandler) FindAllProblems(c *gin.Context) {
	...
	controllerhelper.HandleSecuredFunction(c, func(organizationID userD.OrganizationID, operatorID userD.AppUserID) error {
		...
		if err != nil {
			return liberrors.Errorf("converter.ToProblemFindAllResponse. err: %w", err)
		}
...
func (h *problemHandler) FindProblemByID(c *gin.Context) {
	...
	controllerhelper.HandleSecuredFunction(c, func(organizationID userD.OrganizationID, operatorID userD.AppUserID) error {
		...
		if err != nil {
			return liberrors.Errorf("converter.ToProblemResponse. err: %w", err)
		}
...
// 	controllerhelper.HandleSecuredFunction(c, func(organizationID userD.OrganizationID, operatorID userD.AppUserID) error {
// 		workbookID, err := helper.GetUint(c, "workbookID")
// 		if err != nil {
// 			c.Status(http.StatusBadRequest)
// 			return nil
// 		}
