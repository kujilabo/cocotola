...
func (_m *Transaction) Do(ctx context.Context, fn func(service.RepositoryFactory, userservice.RepositoryFactory) error) error {
	ret := _m.Called(ctx, fn)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, func(service.RepositoryFactory, userservice.RepositoryFactory) error) error); ok {
		r0 = rf(ctx, fn)
	} else {
		r0 = ret.Error(0)
	}
