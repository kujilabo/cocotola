...
go_repository(
    ...
    sum = "h1:SVBwznSETB0Sipd0uyGJr7khLhJOFRUEUb+0JgkCvDo=",
    version = "v67.0.0+incompatible",
)
...
go_repository(
    ...
    sum = "h1:8yvHA/e1noQcDStVXaBg0GrOy+loqEQbXcd56Rqe+Ok=",
    version = "v0.4.0",
)
...
go_repository(
    ...
    sum = "h1:/JhWJhO2v17d8hjApTltKNADm7K7YI2ogkR7avJUL3k=",
    version = "v1.4.3",
)
...
go_repository(
    ...
    sum = "h1:0+dsXf0zeLx9ixj4nilg6jKe5Bg1ilzBwSFq4kJmIUc=",
    version = "v3.16.13-0.20221017192402-261537637ce8",
)
...
go_repository(
    ...
    sum = "h1:E0Hwk1YC0lWXJboAvQrOnDSyVpmdlqC2v4m+GNmNszA=",
    version = "v1.10.1",
)
...
go_repository(
    ...
    sum = "h1:2G1eO4RSvcTNncDivyGTd3Zh9tozmMeA2JpF07QEYlc=",
    version = "v0.34.1",
)
...
go_repository(
    ...
    sum = "h1:4qM+hDfj+i9M6lBbguafWKE/8tJA+9vRY5+l0ZB5WTo=",
    version = "v2.56.0",
)
...
go_repository(
    ...
    sum = "h1:YfHkjwna8MR9B9V81/pvu+rVcz8YzATmJbwqD5fvDuI=",
    version = "v3.12.1",
)
...
go_repository(
    ...
    sum = "h1:mTtntWN3wk9UNjIf6F7Upqnfq96p+cjhfgCsupUd1hY=",
    version = "v1.19.2",
)
...
go_repository(
    ...
    sum = "h1:+8LAEpmywqresSoGlqjjT+I9m4PseIM3NcerIJ/V7mk=",
    version = "v1.5.0",
)
