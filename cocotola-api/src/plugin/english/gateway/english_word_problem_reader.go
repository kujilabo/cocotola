...
import (
	...
	common "github.com/kujilabo/cocotola/cocotola-api/src/plugin/common/domain"
...
func (r *engliushWordProblemAddParameterCSVReader) Next() (appD.ProblemAddParameter, error) {
	var line []string
	line, err := r.reader.Read()
	if errors.Is(err, io.EOF) {
		return nil, liberrors.Errorf("r.reader.Read. err: %w", err)
	}
	if err != nil {
